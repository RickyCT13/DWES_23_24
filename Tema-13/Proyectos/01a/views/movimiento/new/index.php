...
<body>
    ...
    <body>
        ...
        <div class="container">
            ...
            <!-- cabecera -->
            <?php include "views/movimiento/partials/header.php" ?>
            ...
            <!-- Formulario -->
            <form action="<?= URL ?>movimiento/create" method="POST">
                ...
                <!-- Botones de acción -->
                <div class="mb-3">
                    <a name="" id="" class="btn btn-secondary" href="<?= URL ?>movimiento" role="button">Cancelar</a>
