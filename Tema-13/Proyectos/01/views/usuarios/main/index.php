...
<body>
    <div class="container" style="padding-top: 2%;">
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($this->usuarios as $usuario) : ?>
                    <tr>
                        ...
                        <td>
                            <!-- botón eliminar -->
                            <a href="<?= URL ?>usuarios/delete/<?= $usuario->id ?>" title="Eliminar" class="btn btn-danger <?= (!in_array($_SESSION['id_rol'], $GLOBALS['usuarios']['delete'])) ? 'disabled' : '' ?>" onclick="return confirm('¿Está seguro de que desea eliminar este usuario?')">
            ...
            <tfoot>
                <tr>
                    <td colspan="5">Nº Registros: <?= $this->usuarios->rowCount() ?> </td>
                </tr>
            </tfoot>
