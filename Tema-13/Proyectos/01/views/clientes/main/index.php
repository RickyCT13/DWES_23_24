...
<body>
    <div class="container" style="padding-top: 2%;">
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($this->clientes as $cliente) : ?>
                    <tr>
                        ...
                        <td>
                            <!-- botón eliminar -->
                            <a href="<?= URL ?>clientes/delete/<?= $cliente->id ?>" title="Eliminar" class="btn btn-danger <?= (!in_array($_SESSION['id_rol'], $GLOBALS['clientes']['delete'])) ? 'disabled' : '' ?>" onclick="return confirm('¿Está seguro de que desea eliminar este cliente?')">
            ...
            <tfoot>
                <tr>
                    <td colspan="9">Nº Registros: <?= $this->clientes->rowCount() ?> </td>
                </tr>
            </tfoot>
