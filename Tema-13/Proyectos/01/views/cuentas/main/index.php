...
<body>
    <div class="container" style="padding-top: 2%;">
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($this->cuentas as $cuenta) : ?>
                    <tr>
                        ...
                        <td>
                            <!-- botón eliminar -->
                            <a href="<?= URL ?>cuentas/delete/<?= $cuenta->id ?>" title="Eliminar" class="btn btn-danger <?= (!in_array($_SESSION['id_rol'], $GLOBALS['cuentas']['delete'])) ? 'disabled' : '' ?>" onclick="return confirm('¿Está seguro de que desea eliminar esta cuenta?')">
            ...
            <tfoot>
                <tr>
                    <td colspan="10">Nº Registros: <?= $this->cuentas->rowCount() ?> </td>
                </tr>
            </tfoot>
