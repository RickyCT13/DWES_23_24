    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <!-- PDF -->
                <li class="nav-item">
                    <a class="nav-link <?= (in_array($_SESSION['id_rol'], $GLOBALS['cuentas']['pdf']) || in_array($_SESSION['id_rol'], $GLOBALS['cuentas']['pdf'])) ? 'active' : 'disabled' ?>" aria-current="page" href="<?= URL ?>cuentas/pdf">Exportar PDF</a>
                </li>
