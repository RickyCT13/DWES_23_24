...
class Alumno extends Controller
{
    ...
    function render()
    {
        ...
        // Si es asi, asignar a una variable
        if (isset($_SESSION['mensaje'])) {
            $this->view->mensaje = $_SESSION['mensaje'];
            // borramos el original para que no se muestre repetidamente
    ...
    function new()
    {
        ...
        if(isset($_SESSION['error'])) {
            ...
            // Autorellenar formulario con detalles del alumno
            $this->view->alumno = unserialize($_SESSION['alumno']);

            // Recuperar array de errores especificos
            $this->view->errores = $_SESSION['errores'];

            // Eliminar vars. de sesión
    ...
    function create($param = [])
    {
        ...
        if (!empty($errores)) {
            ...
            $_SESSION['error'] = 'Formulario no se ha validado';
