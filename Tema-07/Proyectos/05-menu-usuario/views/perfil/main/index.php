...
<head><?php require_once("template/partials/head.php") ?>
    <title>Detalles perfil</title>
</head>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <br><br><br>
                ...
                <div class="card">
                    <div class="card-header">Detalles Perfil Usuario</div>
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="perfil" value="<?= $_SESSION['name_rol'] ?>" disabled autofocus>
                                </div>
                            </div>
